/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 378e9f2a9452152eb0c505ab739ca839)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://iad.mcc0nnell.org" | "http://127.0.0.1:8787,http://localhost:8787,http://127.0.0.1:5173,http://localhost:5173";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_ORIGINS: "https://iad.mcc0nnell.org";
		SESSION_SECRET: string;
		TOKEN_SIGNING_SECRET: string;
		SCHEDULE_SIGNING_SECRET: string;
		CALL_ROOM: DurableObjectNamespace<import("./index").CallRoom>;
