/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: ca44819661e1c528266ec1c54110a7f8)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://omni.example.invalid" | "http://127.0.0.1:8787,http://localhost:8787,http://127.0.0.1:5173,http://localhost:5173";
	SESSION_SECRET: string;
	TOKEN_SIGNING_SECRET: string;
	SCHEDULE_SIGNING_SECRET: string;
	CALL_ROOM: DurableObjectNamespace<import("./index").CallRoom>;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_ORIGINS: "https://omni.example.invalid";
		SESSION_SECRET: string;
		TOKEN_SIGNING_SECRET: string;
		SCHEDULE_SIGNING_SECRET: string;
		CALL_ROOM: DurableObjectNamespace<import("./index").CallRoom>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "SESSION_SECRET" | "TOKEN_SIGNING_SECRET" | "SCHEDULE_SIGNING_SECRET">> {}
}
